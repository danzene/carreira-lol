...
//
// RAZÃO vs jogo ativo (documentada; validada por simulação em engine/grind.test.ts):
//   soloq ativa paga $25/vitória → normal paga $3 (12%) / $1 derrota
//   soloq dá maestria +4 V / +1.5 D → normal dá +0.6 (15%) / +0.25 (17%)
